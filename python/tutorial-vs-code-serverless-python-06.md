---
title: Visual Studio Code를 사용하여 Azure Functions에 두 번째 Python 함수 추가
...
1. **Azure:  Functions**탐색기에서 **함수 앱에 배포**를 사용하여 코드를 다시 배포합니다. 메시지가 표시되면 이전에 만든 함수 앱을 선택합니다.
