...
- [빠른 시작: CentOS에 Azure용 Ansible 솔루션 템플릿 배포](./solution-template-deploy.md)
- [빠른 시작: Ansible을 사용하여 Azure에서 Linux 가상 머신 구성](./install-on-linux-vm.md)