...
* [주요 변경 사항] 'az acr task create/update' 분기 매개 변수가 제거됨
...
* [주요 변경 사항] omsagent의 GF 및 BF에 대한 msi 변경 지원(컨테이너 모니터링)(#1)
...
* [주요 변경 사항] az image template: 이름을 템플릿에서 빌더로 변경
...
* [주요 변경 사항] #10728 해결: `az vm create`: VNet이 지정되어 있지만 서브넷이 없는 경우 서브넷을 자동으로 만듦
...
* [주요 변경 사항] 'az acr task delete' 메시지가 표시됨
...
* [주요 변경 사항] #11883 해결: `az role assignment create`: 빈 범위에서 오류 메시지 표시
