...
|---|---|
| **Azure Functions** ||
| [SAS 토큰을 생성하는 Node.js Azure 함수(영문)](https://azure.microsoft.com/resources/samples/functions-node-sas-token/) | Blob 또는 컨테이너 스토리지 SAS 토큰을 가져오는 Node.js Azure 함수입니다. |
| **가상 머신 관리** ||
